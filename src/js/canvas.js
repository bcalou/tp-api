...
window.onload = function () {
  ...
  houseImage.src =
    "https://drive.google.com/uc?id=1YO5Mg6IzlskREYSRcr2Ut00JZI49ivnR";

  //main sound
  var mainTheme = new Audio(
    "https://drive.google.com/uc?id=1ljrlJ1UBrH4YnIpxH02jqR_oJeLZhkDv"
  );
  mainTheme.loop = true;
  ...
  var pokePick = new Audio(
    "https://drive.google.com/uc?id=1ULOY_JeGQWJ0SOcxQfBtNQ77e20sWa31"
  );
  pokePick.volume = 0.8;
  ...
  playerImage.src =
    "https://drive.google.com/uc?id=1ZsYCAWG7uR2_nZTVsIOOUog4tXFIUsgB";
  ...
  pokeballImage.src =
    "https://drive.google.com/uc?id=1XiXaiRlytnRI2ncwnBWyyef79guxI55X";
